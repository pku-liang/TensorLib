...
class TensorIndex(indexes: List[IteratorExpr], tensor: Tensor) extends TensorExpr {
  ...
  def generate()                            = throw new Exception("Can't generate a Tensor index")
  def generate_d()                          = throw new Exception("Can't generate a Tensor index")
  def calc(): Int                           = throw new Exception("Can't calculate a Tensor index")
  def calc_d(): Double                      = throw new Exception("Can't calculate a Tensor index")
